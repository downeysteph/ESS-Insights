...
| **Get the template** | [`ESS Dashboard Template 1.3 (CSV Upload).pbit`](./ESS%20Dashboard%20Template%201.3%20(CSV%20Upload).pbit) | [`ESS Dashboard Template 1.3 (Dataverse).pbit`](./ESS%20Dashboard%20Template%201.3%20(Dataverse).pbit) |
